...
public class Servlet07 extends HttpServlet {
	...
	// servletの行列番号
	private static final int SERVLET_NO = 7;

	private static final Logger logger = Logger.getLogger(Servlet07.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.getWriter().write("{\"result\":\"success\",\"servlet\":\"servlet07\"}");
