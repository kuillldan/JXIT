...
<%
	...
	//查询调用的后台url: pages/admin/list
	String url = (String) request.getAttribute("url");
	//columnData: 查询需要的字段列表.如: 地址:address|电话:phone
	...
	<form action="xx.action" method="post" class="form-group" id="splitSearchForm">
		<fieldset>
			<div class="form-group">
				...
				%>
				<div class="col-md-5">
					<input type="text" name="kw" id="kw" class="form-control input-sm" value="${keyWord}"
						placeholder="请输入检索关键字">
				</div>
				<div class="col-md-2">
					<button type="button" onclick="goSplit(1)" class="btn btn-primary">检索</button>
					<input type="hidden" name="${paramName}" value="${paramValue}"> <input type="hidden" name="cp"
						value="1">
				</div>
			</div>
		</fieldset>
