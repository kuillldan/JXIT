...
public abstract class AbstractDAOImpl
{
	 ...
	 * @return
	 */
	public boolean removeHandler(String tableName, String column, Set<?> ids) throws Exception
	{
		if(ids.size() <= 0)
			return false;
...
//		System.out.println("[debug] " + sql.toString());
	 ...
	 * @return
	 */
	public Integer countHandler(String tableName, String column, String keyWord) throws Exception
	{
	...
	protected Set<String> findAllPhotosByIds(String tableName, String photoColumn, String idColumn, Set<?> ids)throws Exception
	{
