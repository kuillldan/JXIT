...
<%
	String searchUrl = basePath + "pages/back/admin/member/MemberServletBack/list";
	String activeAllMembersUrl = basePath + "pages/back/admin/member/MemberServletBack/updateMembersStatus?type=active";
	String disableAllMembersUrl = basePath + "pages/back/admin/member/MemberServletBack/updateMembersStatus?type=disable";
