...
<%
	String searchUrl = basePath + "pages/back/admin/emp/emp_list_split.jsp";
%>
...
<%
	Map<String, Object> result = ServiceFactory.getIEmpServiceInstance().listBySplit(currentPage, lineSize,
	columnName, keyWord);
	...
	String backUrl = "pages/back/admin/emp/emp_list_split.jsp&columnName=" + columnName + "&keyWord="
...
<body>
	...
	<table border="1" cellpadding="5" cellspacing="0" bgColor="#F2F2F2">
		...
		<tr>
			<td colspan="10"><input type="button" value="删除选中员工信息" onclick="deleteAll('<%=empDeleteUrl%>?p=1&backUrl=<%=backUrl%>','ids','empno')" /> 
