    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          ...
          <li><a href="<%=basePath %>pages/back/admin/emp/emp_list.jsp" target="main">总列表</a></li>
      ...
      <div class="content">
        ...
        <ul class="MM">
		  ...
		  <li><a href="<%=basePath %>pages/back/admin/dept/DeptServlet/listDetails" target="main">部门详细列表</a></li>
