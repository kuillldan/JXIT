...
public class Servlet01 extends HttpServlet {
	...
	// servletの行列番号
	private static final int SERVLET_NO = 1;

	private static final Logger logger = Logger.getLogger(Servlet01.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.getWriter().write("{\"result\":\"success\",\"servlet\":\"servlet01\"}");
