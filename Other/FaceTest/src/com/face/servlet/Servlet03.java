...
public class Servlet03 extends HttpServlet {
	...
	// servletの行列番号
	private static final int SERVLET_NO = 3;

	private static final Logger logger = Logger.getLogger(Servlet03.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.getWriter().write("{\"result\":\"success\",\"servlet\":\"servlet03\"}");
