...
public class Servlet09 extends HttpServlet {
	...
	// servletの行列番号
	private static final int SERVLET_NO = 9;

	private static final Logger logger = Logger.getLogger(Servlet09.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.getWriter().write("{\"result\":\"success\",\"servlet\":\"servlet09\"}");
