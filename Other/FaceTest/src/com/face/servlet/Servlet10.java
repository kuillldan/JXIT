...
public class Servlet10 extends HttpServlet {
	...
	// servletの行列番号
	private static final int SERVLET_NO = 10;

	private static final Logger logger = Logger.getLogger(Servlet10.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.getWriter().write("{\"result\":\"success\",\"servlet\":\"servlet10\"}");
