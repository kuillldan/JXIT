...
<%
	...
	String searchByItemURL =  basePath + "pages/front/goods/GoodsServlet/list";
	String goodsShowURL = basePath + "pages/front/goods/GoodsServlet/show";
	String addToShopCartURL = basePath + "pages/front/shopCart/ShopCarServlet/add";
%>
...
<body>
	...
	<h1>allGoodsCount: ${allGoodsCount }</h1>
